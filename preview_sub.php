						...
						<div class="col-12 col-lg-12">
							<div class="card">
								<div class="card-body">
									...
									<?php
                        			    $sql_folders = "SELECT * FROM items WHERE parent = '$current_folder' AND state = 'Live'";
                                    ...
                                    ?>
										...
										<div class="col-12 col-lg-3 item">
										  <a <?php if($folders_type == 'Folder' || $folders_type == 'DropBox'){ ?> href="preview_sub?/<?= rand(1,1000000); ?>/<?= $folders_id; ?>" 
