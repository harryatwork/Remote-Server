        ...
        <div class="page-content-wrapper" style="margin-left: 0;">
				<div class="page-content">
					...
					<div class="row">
                            			...
                            			<div class="modal-body">
                            				...
                            				<form action="backend_functions/upload_files" method="POST" enctype='multipart/form-data'>
                                    			...
                                    			<div class="modal-footer">
                                    				...
                                    				<button type="submit" class="btn btn-light file_upload_btn">Upload</button>
                                    			</div>
                                    			-->
                                    		</form>
                                    	</div>
						...
						<div class="col-12 col-lg-12">
							<div class="card">
							    <h4 style="padding: 22px 0px 0 22px;font-size: 22px;font-weight: 600;">Files Uploaded By You</h4>
								<div class="card-body">
									<div class="row mt-3">
										
									<?php
                        			    $sql_folders = "SELECT * FROM items WHERE parent = '$folders_id' AND state = 'Live'";
                                    	$result_folders = $conn->query($sql_folders);
                                    	if ($result_folders->num_rows > 0) {   
                                    	while($row_folders = $result_folders->fetch_assoc()) {
                                    		$folders_id = $row_folders["id"];
                                    ...
                                    ?>
										...
										<div class="col-12 col-lg-3 item">
										  <a <?php if($folders_type == 'Image' || $folders_type == 'Png' || $folders_type == 'Jpeg' || $folders_type == 'Jpg' || $folders_type == 'Gif') { ?> id="item_href" data-toggle="modal" data-target="#exampleModal8" data-type="image" data-img="<?= $file_name; ?>" 
										     <?php } elseif($folders_type == 'Video' || $folders_type == 'Mp4' || $folders_type == 'Webm' || $folders_type == 'Ogg' || $folders_type == 'Mov') { ?> id="item_href" data-toggle="modal" data-target="#exampleModal8" data-type="video" data-img="<?= $file_name; ?>" 
