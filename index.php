						...
						<div class="col-12 col-lg-12">
							<div class="card">
								<div class="card-body">
									...
									<?php
								// 	$temp = calc_size();
                        			    $sql_folders = "SELECT * FROM items WHERE parent = 0 AND private = 0 AND state = 'Live' ORDER BY name ASC";
											  ...
											  <?php if($folders_type == 'Image' || $folders_type == 'Png' || $folders_type == 'Jpeg' || $folders_type == 'Jpg' || $folders_type == 'Gif') { } else { ?>
													...
													<div class="d-flex align-items-center" style="text-align: center;">
														<div class="fm-icon-box" style="width: 100%;height: auto;padding: 10%;">
														  ...
														  <?php } else { ?>
														    <?php if($folders_name == 'VDOfy-ONLINE Orders') { ?>
														        <img src="https://vdofy.com/wp-content/uploads/2020/10/VDOfy-LOGO-PNG-white.png" alt="" style="width:120%;" />
														    <?php } elseif($folders_name == 'DropBox') { ?>
														        <i class="fadeIn animated bx bx-cloud-upload" style="font-size:65px;line-height: 1;"></i>
														    <?php } else { ?>
